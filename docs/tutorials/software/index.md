...
<!--
  ...
  tutorial pages underneath just need parent: Software and grand_parent: Tutorials.
...
Onboarding sequence for the Software subteam. Work through these roughly in order —
later tutorials assume you've completed the earlier ones.

## What you'll need

- Software / tools list (e.g. KiCad, multimeter, etc.)
